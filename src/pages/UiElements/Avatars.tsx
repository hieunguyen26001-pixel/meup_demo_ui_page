...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | meup - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for meup - React.js Tailwind CSS Admin Dashboard Template"
      />
